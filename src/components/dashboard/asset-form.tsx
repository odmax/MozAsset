      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Dell Latitude 5540" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="DL5540-001" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Current state of the asset</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <FormField
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Department, location, and assigned user</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-4 md:grid-cols-2">
              <FormField
